...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['Good', 0.2], //From 0% to 19%
		['Great', 0.4], //From 20% to 39%
		['Awesome', 0.5], //From 40% to 49%
		['Outstandjng', 0.6], //From 50% to 59%
		['AMAZING!', 0.69], //From 60% to 68%
		['funny sex position, 0.7], //69%
		['Meh my brother could do better', 0.8], //From 70% to 79%
		['Deez', 0.9], //From 80% to 89%
		['ok', 1], //From 90% to 99%
		['HOLY SHIT YOU HIT A CLIP', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
	...
	override public function create()
	{
		...
		if (!inEditor) {
			botplayTxt = new FlxText(400, timeBarBG.y + 55, FlxG.width - 800, "Noob Mode", 32);
